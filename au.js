...
class Client {
    ...
    loadGUI() {
		...
		<input onchange="localStorage.setItem('botNick', this.value);" id="botNick" maxlength="15" class="form-control" placeholder="Bot Name" value="Bot Name"></input>
    ...
    stopBots() {
        ...
        this.startedBots = false;
		$('#botsaliveone').replaceWith(`<button id='botsnotalive' class='btn btn-danger'>Bots alive: 0/100</button>`);
    }
